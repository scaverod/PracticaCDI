...
public class PanelSpaEmergenteBase_BKP extends JPanel {
	...
	public PanelSpaEmergenteBase_BKP(MicroControladorLayersPadreHijo microControlador, String padre, Controlador controlador, Semaphore s) {
		this.s = s;
