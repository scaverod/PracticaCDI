...
public class PanelServiciosPrincipal extends JPanel {
	...
	public PanelServiciosPrincipal(MicroControladorPanelesPadreHijo m, String hijo) {
		...
		btnMiniBar.setIcon(new ImageIcon(PanelServiciosPrincipal.class.getResource("/iconos/minibarnew.png")));
		...
		btnCambioToalla.setIcon(new ImageIcon(PanelServiciosPrincipal.class.getResource("/iconos/towel.png")));
		...
		btnTelefono.setIcon(new ImageIcon(PanelServiciosPrincipal.class.getResource("/iconos/phone.png")));
		...
		btnHorarioLimpieza.setIcon(new ImageIcon(PanelServiciosPrincipal.class.getResource("/iconos/horariolimpieza.png")));
		...
		btnBotones.setIcon(new ImageIcon(PanelServiciosPrincipal.class.getResource("/iconos/botones.png")));
		...
		btnCambioAlmohada.setIcon(new ImageIcon(PanelServiciosPrincipal.class.getResource("/iconos/almohada.png")));
		...
		btnComidaHab.setIcon(new ImageIcon(PanelServiciosPrincipal.class.getResource("/iconos/comidahab.png")));
		...
		btnPedirTaxi.setIcon(new ImageIcon(PanelServiciosPrincipal.class.getResource("/iconos/taxi.png")));
		...
		btnTelevision.setIcon(new ImageIcon(PanelServiciosPrincipal.class.getResource("/iconos/television.png")));
		...
		btnWifi.setIcon(new ImageIcon(PanelServiciosPrincipal.class.getResource("/iconos/wifi.png")));
		...
		btnInformacion.setIcon(new ImageIcon(PanelServiciosPrincipal.class.getResource("/iconos/info.png")));
